...
public class NotesDbAdapter {
     ...
     */
    public long createNote(String title, String subject, String body, String date) {
    ...
    public Cursor fetchNote(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                    KEY_TITLE,KEY_SUBJECT, KEY_BODY,KEY_DATE}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateNote(long rowId, String title,String subject, String body,String date) {
